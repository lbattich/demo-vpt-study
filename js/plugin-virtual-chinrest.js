var jsPsychVirtualChinrest = (function (jspsych) {
  ...
  const info = {
      ...
      parameters: {
          ...
          <p>Please follow these instruction very carefully! If your position doesn't correspond to the study's requirements, your participation will have to be terminated and you will be asked to return your Prolific submission.</p>
          <div style="text-align: left">
            <ol>
              <li>Sit in a straight, relaxed and comfortable position.</li>
              <li>Extend your arm towards the screen. Adjust your position until your fingertips should be between 0 and 10cm away the screen.</li>
      ...
      `;
          ...
          const finishBlindSpotPhase = () => {
              ...
              if (trial.viewing_distance_report == "none") {
                  ...
                  showReport();
                  console.log("blindspot_config_data");
                  console.log(blindspot_config_data);
